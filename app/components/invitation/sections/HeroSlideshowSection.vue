...
<template>
  <section class="relative overflow-hidden py-32 text-center text-white min-h-screen flex flex-col items-center justify-center" style="background: var(--color-bg)">
