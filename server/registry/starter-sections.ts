...
const WEDDING_SECTIONS: SectionType[] = [
  "hero",
  "opening",
  "couple",
  "event",
...
const WEDDING_METATAH_SECTIONS: SectionType[] = [
  "hero",
  "opening",
  "couple",
  "member",
...
export const STARTER_CONFIG: Record<string, StarterConfig> = {
  wedding: {
    ...
    content: {
      ...
      closing: {
        body: "Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila Bapak/Ibu/Saudara/i berkenan hadir dan memberikan doa restu.",
      },
      footer: { text: FOOTER },
    },
  },
  wedding_metatah: {
    ...
    content: {
      ...
      closing: {
        body: "Atas kehadiran dan doa restu Bapak/Ibu/Saudara/i, kami haturkan terima kasih.",
      },
      footer: { text: FOOTER },
    },
  },
  metatah: {
    ...
    content: {
      ...
      closing: {
        body: "Atas kehadiran dan doa restunya, kami ucapkan terima kasih.",
      },
      footer: { text: FOOTER },
    },
  },
  ...
  birthday: {
    ...
    content: {
      ...
      closing: {
        body: "Kehadiranmu adalah hadiah terbaik. Sampai jumpa di hari spesial nanti!",
      },
      footer: { text: FOOTER },
    },
  },
...
export function wordToContent(
  word: InvitationWordContent,
): Partial<Record<SectionType, Record<string, any>>> {
...
export function starterDocument(
  type: string,
  word?: InvitationWordContent | null,
): InvitationDocument {
